  ...
  return (
    <section id="specs" className="px-5 py-24">
      <div className="max-w-4xl mx-auto">
        <div className="mb-10">
          <span className="kicker"><span className="dev-only">// pykey --specs</span><span className="simple-only">Specifications</span></span>
          <h2 className="display text-[clamp(2rem,5.5vw,4rem)] mt-3">the <span className="flame-text">datasheet</span>.</h2>
        </div>
        <div className="border border-line font-mono simple:font-sans text-[13px] simple:rounded-xl">
          {SPECS.map(([k, v], i) => (
